...
const char *GScriptId = "AKfycbwnul-ntjXWQ2EAsIBZ8bhymBMurtnQ7v5hnUWnGn39C3L29DYzTut3cap-zdj3a69LWA";
//---------------------------------------------------------------------------------------------------------
...
void loop() {
  ...
  // values = "\"" + value0 + "," + value1 + "," + value2 + "\"}"
    if(ct%2!=0)
  {
    payload = payload_base + values + "Entry\"}";
    ct+=1;
  }
  else
  {
    payload = payload_base + values + "Exit\"}";
    ct+=1;
  }
  //----------------------------------------------------------------
  //----------------------------------------------------------------
